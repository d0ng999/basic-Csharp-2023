...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            LsvFolder.Columns.Add("이름", (LsvFolder.Width / 2),
                HorizontalAlignment.Left); // dir.Name file.Name
            LsvFolder.Columns.Add("날짜", (LsvFolder.Width / 4),
                HorizontalAlignment.Left);
            LsvFolder.Columns.Add("유형", (LsvFolder.Width /5),
                HorizontalAlignment.Left);
            LsvFolder.Columns.Add("크기", (LsvFolder.Width / 5),
        ...
        private void FillNodes(TreeNode curNode)
        {
            ...
            {
                MessageBox.Show("트리 뷰 오류발생!", "오류", MessageBoxButtons.OK,
        ...
        private void SetLsvFolder(string fullPath)
        {
            try
            {
                ...
                foreach (DirectoryInfo item in dir.GetDirectories())
                {
                    ...
                    LsvFolder.Items[dirCount].SubItems.Add( string.Format
                        ("{0} files",item.GetFiles().Length.ToString()) );
                ...
                int fileCount = dirCount; // 이전 카운트가 승계되어야 함
            ...
            {
                MessageBox.Show("리스트 뷰 오류발생!", "오류", MessageBoxButtons.OK,
                                    MessageBoxIcon.Error);
            }
        }
        /// <summary>
        ...
        private int SetExtImg(string name)
        {
            ...
            string ext = fInfo.Extension; // 파일의 확장자를 가지고 온다
            var exVal = 0;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CvoView_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            if (e.KeyChar == 13) // KeyBoard Enter키를 누르면
            {
                try
                {
                ...
                {
                    MessageBox.Show("경로를 찾을 수 없습니다. 맞춤법을 확인하고 다시 시도해주세요",
                        "나의 탐색기", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        /// <summary>
        /// 리스트뷰 파일 더블클릭시 처리 이벤트
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
