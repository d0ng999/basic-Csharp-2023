...
namespace cs17_inheritance
{
    ...
    class Parent
    {
        public string Name; // 상속을 받을 때는 private을 쓰면 안됨
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (mammal is Dogs)
            {
                Dogs midDog = mammal as Dogs; // (Dogs)mammal 구식 방법
                midDog.Bark();
            }
